package mnk.data.mysql.controller
...
import mnk.data.mysql.test.services.TestHelperService
...
class BookControllerSpec extends Specification {
    ...
    void 'Retrieve books from a non-existing author return NOT_FOUND'() {
        given: 'Author data'
        String author = "who-are-you"

        when: 'Retrieve endpoint is called with an invalid author'
